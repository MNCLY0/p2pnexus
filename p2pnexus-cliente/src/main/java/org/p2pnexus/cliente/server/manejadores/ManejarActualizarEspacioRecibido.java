...
public class ManejarActualizarEspacioRecibido implements IManejadorMensaje {
    @Override
    public ResultadoMensaje manejarDatos(Mensaje mensaje, SocketConexion socketConexion) throws ManejarPeticionesExeptionError {
        ...
        ControladorChat.instancia.gestorEspacios.actualizarEspacioRecibido(espacio, conversacion);
