...
public class ManejarRecibirRespuestaP2P implements IManejadorMensaje {
    @Override
    public ResultadoMensaje manejarDatos(Mensaje mensaje, SocketConexion socketConexion) throws ManejarPeticionesExeptionError {

        String sdp = mensaje.getData().get("sdp").getAsString();
        ...
        if (gestor == null) {
            System.out.println("No se ha realizado ninguna oferta a este usuario");
            return null;
        }

        gestor.recibirRespuesta(sdp);
