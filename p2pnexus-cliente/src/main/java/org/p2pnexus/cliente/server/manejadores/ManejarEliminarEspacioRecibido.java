...
public class ManejarEliminarEspacioRecibido implements IManejadorMensaje {
    ...
    public ResultadoMensaje manejarDatos(Mensaje mensaje, SocketConexion socketConexion) throws ManejarPeticionesExeptionError {
        ...
        ControladorChat.instancia.gestorEspacios.eliminarEspacioRecibido(espacio, conversacion);
